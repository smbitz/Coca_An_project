...
public class InterceptTouchGallery extends Gallery {
  ...
  public InterceptTouchGallery(Context context) {
      super(context);
      initCustomGallery(context);
  }

  public InterceptTouchGallery(Context context, AttributeSet attrs) {
      super(context, attrs);
      initCustomGallery(context);
  }
